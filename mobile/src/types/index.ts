...
export type ParcelStatus = 'PENDING' | 'ACCEPTED' | 'PACKAGING_CONFIRMED' | 'PICKED_UP' | 'DELIVERED' | 'CANCELLED' | 'EXPIRED';
...
export type DocumentType = 'ID_CARD_FRONT' | 'ID_CARD_BACK' | 'KBIS' | 'VEHICLE_REGISTRATION' | 'DRIVING_LICENSE';
