import { ParcelStatus, ParcelSize, DropoffType, Carrier, PickupMode, MissionStatus } from '@prisma/client';
  ...
  async createParcel(vendorId: string, input: CreateParcelInput) {
    ...
    const parcel = await prisma.parcel.create({
      data: {
        ...
        carrier: (input.carrier as Carrier) || Carrier.OTHER,
        hasShippingLabel: input.hasShippingLabel ?? false,
        shippingLabelUrl: input.shippingLabelUrl,
        qrCodeUrl: input.qrCodeUrl,
        pickupInstructions: input.pickupInstructions,
        itemPhotoUrl: input.itemPhotoUrl,
        itemCategory: input.itemCategory,
        pickupMode: input.pickupMode || PickupMode.SCHEDULED,
